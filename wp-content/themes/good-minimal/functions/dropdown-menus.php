...
class DropDown_Menu_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'dropdown-menu-widget', 'description' => 'Use this widget to add one of your custom menus as a dropdown.' );
		parent::__construct( 'dropdown_menu', 'Dropdown Menu', $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'nav_menu' ); ?>"><?php echo 'Select Menu:'; ?></label>
